...
function Navbar() {
  ...
  return (
    <nav className="fixed bg-black flex justify-between items-center gap-16 py-3 px-10 left-1/2 translate-x-[-50%] top-[20px] rounded-full backdrop-blur-md bg-opacity-60 text-white shadow-lg z-10 text-sm">
      ...
      <button className="uppercase bg-gradient-to-r from-blue-900 to-gray-600 py-1 px-6 rounded-3xl shadow-2xl text-white hover:scale-105 transition-all duration-300 ease-in-out font-semibold hover:from-blue-950 hover:to-gray-500 hover:shadow-blue-600 shadow-gray-300">
        Signup / Register
      </button>
    </nav>
  );
